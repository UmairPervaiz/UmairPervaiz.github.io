    ...
    <div className="w-full">
      ...
      <div className="max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 pt-8">
        <div className="col-span-4">
          <h2>Overview</h2>
          <p className="mb-5">
              iCarePro is a fully HIPAA-compliant electronic medical records (EMR) portal. It allows different 
              medical practices to register and manage their doctors, ensuring secure handling of patient data.
          </p>
          ...
          <ul>
              ...
              <li className="mb-5">
                  Registration and management of medical practices and doctors
              </li> 
          </ul>
