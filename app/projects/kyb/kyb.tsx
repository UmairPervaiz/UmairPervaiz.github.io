    ...
    <div className="w-full">
      ...
      <div className="max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 pt-8">
        <div className="col-span-4">
          <h2>Overview</h2>
          <p className="mb-5">
              KYB is a content management system (CMS) designed for businesses to manage 
              their "Know Your Business" compliance, ensuring that companies meet regulatory requirements.
          </p>
          <h2 className="mb-5">Key Features:</h2>
          <ul>
              <li className="mb-5">
                  Business compliance management through CMS
              </li>
          </ul>
